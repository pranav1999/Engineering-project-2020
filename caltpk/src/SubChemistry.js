...
export const class9 = [
    {
        id:1,
        title:"Litmus Test",
        img:"https://www.thoughtco.com/thmb/d33nWy5hzLiGgckifUkghwcXims=/768x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/litmus-test-strips-on-top-of-plastic-cups-with-various-multicolored-liquids-studio-shot-sb10068106g-001-582dec215f9b58d5b180eea2.jpg",
        description:"Litmus paper is a filter paper that has been treated with a lichen-provided natural-soluble dye. Litmus paper is a piece of paper that produces a result which can be used as a pH indicator.Litmus is mainly used to assess whether a solution is acidic or basic. The colour transition occurs over the pH range 4.5–8.3 at 25 °C (77 °F), with light blue litmus paper turning red under acidic conditions and red litmus paper turning blue under basic or alkaline conditions. Purple litmus paper is neutral.",
        videolink:"https://www.youtube.com/watch?v=Bnj2lpD0Z3w",
        explink:"https://simmer.io/@Buoyancy/litmus-test",
        theory:"https://www.bellevuecollege.edu/wp-content/uploads/sites/140/2014/06/Lab_AcidsBasesBuffers-09-16-2016.pdf"
    },
    {
        id:2,
        title:"Separate the components of a mixture of sand, common salt and ammonium chloride",
        img:"https://images.unsplash.com/photo-1519017920617-b77f448b702b?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1789&q=80",
        description:"Natural substances are not chemically pure. Different methods of separation are used to get individual components from a mixture.But, before separating any components from a mixture one must have sound knowledge of its physical and chemical properties so that separation can be done with ease,Sand, common salt and ammonium chloride form a heterogeneous mixture which can be separated easily through simple physical methods of separation In the mixture given ammonium chloride is a sublimating substance. On heating the mixture, sublimating substance directly changes into gaseous state, its fumes are collected and cooled to get solid sublimate To separate mixture of salt and sand following processes are used: Dissolve the mixture in water ==> as one substance is soluble and the other (sand) is insoluble,Sedimentation’ sand settles down at the bottom of the solution,Evaporation:The water from salt solution is evaporated by heating to get salt.",
        videolink:"https://www.youtube.com/watch?v=tQdvPTPlU1M",
        explink:"",
        theory:"https://lakshya3119.github.io/chem/All-Chem-Class9/EXP2.html"
    },
    {
        id:3,
        title:"Type of reaction and Changes",
        img:"https://images.unsplash.com/photo-1554475901-4538ddfbccc2?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1952&q=80",
        description:"When there is no change in the composition of a substance and no change in chemical nature of the substance, such change is called as physical change,In physical change, the interconversion of state takes place.It is a change which brings change in the chemical properties of matter and a new substance is obtained. For example, burning of oil, fuel,n a chemical change – heat is evolved or taken in, formation of bubbles, gas, fumes takes place, there is a change in colour of the reactants when they form a product.Combination reaction: Two elements/compounds combine to form a single product.Decomposition reaction: When a compound decomposes/breaks due to energy, heat, light or electricity to form simpler substance.Displacement reaction: It takes place when more reactive metal reacts with the salt of less reactive metal and displaces it to form a new compound.Double displacement reaction: In this reaction when two salts are mixed together in solution form then exchange of ions takes place and a new product is obtained.",
        videolink:"https://www.youtube.com/watch?v=kifKFnx8vjM",
        explink:"",
        theory:"https://lakshya3119.github.io/chem/All-Chem-Class9/EXP3.html"
    }
...
export const class10 = [
    {
        id:1,
        title:"Cleaning Capacity of Soap in Hard and Soft Water",
        img:"https://images.pexels.com/photos/62600/pexels-photo-62600.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500",
    ...
    },
    {
        ...
        img:"https://cdn11.bigcommerce.com/s-ufhcuzfxw9/images/stencil/1280x1280/products/15110/17999/_MG_7472__53558.1593441306.jpg?c=2",
    ...
    },
    {
        ...
        img:"https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse1.mm.bing.net%2Fth%3Fid%3DOIP.swu7ScIWbEUU0pfyq5blgwHaE8%26pid%3DApi&f=1",
...
export const class11 = [
    {
        id:1,
        title:"Determine the Boiling point of the given solid substance.",
        img:"https://images.unsplash.com/photo-1598763555653-573648fbd120?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=967&q=80",
    ...
    {
        id:3,
        title:"Effect of Change of Concentration on Chemical Equilibrium",
        img:"https://images.unsplash.com/photo-1608037222022-62649819f8aa?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=334&q=80",
...
export const class12 = [
    {
        ...
        img:"https://images.unsplash.com/photo-1542984694-0ac03f299f56?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1053&q=80",
    ...
    },
    {
        ...
        img:"https://images.unsplash.com/photo-1554475901-e2ce1a3f857e?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1052&q=80",
